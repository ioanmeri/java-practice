...
public class Serializable1 {
    public static void main(String[] args) throws Exception{
        var t = new Tooby();
        t.i = 100;
        var oos  = new ObjectOutputStream(new FileOutputStream("c:\\tmp\\test.ser"));
        oos.writeObject(t);
        oos.close();

        var ois = new ObjectInputStream(new FileInputStream("c:\\tmp\\test.ser"));
...
// Data members of Booby will not be serialized.
// Thus, the value of i (which is 100) at the time of serialization will not be saved in the file.
//
